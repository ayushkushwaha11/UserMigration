...
//    }
    ...
    public ResponseEntity<String> addCustomerUser(@RequestParam String name,@RequestParam String mobileNo,@RequestParam String email,@RequestParam String cif,@RequestParam long niyoCustomerCompanyId,@RequestParam Boolean consent){
